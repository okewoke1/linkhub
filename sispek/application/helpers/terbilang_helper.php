...
if (!function_exists('terbilang')) {
    function terbilang($angka)
    {
        ...
        if ($angka < 12) {
            ...
            $temp = terbilang(floor($angka / 1000000000)) . " milyar" . terbilang(fmod($angka, 1000000000));
        } else if ($angka < 1000000000000000) {
            $temp = terbilang(floor($angka / 1000000000000)) . " trilyun" . terbilang(fmod($angka, 1000000000000));
        }
        return $temp;
    }
}
