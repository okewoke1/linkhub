             ...
             <div class="row">
                 ...
                 <div class="col-md-6">
                     ...
                     <div class="card card-success">
                         ...
                         <form action="<?php echo base_url() . 'sispek/mitra/update' ?>" method="post">
                             <div class="card-body">
                                 <div class="form-group">
                                     <label for="">Nama Mitra</label>
                                 ...
                                 <div class="card-footer text-right">
                                     ...
                                     <button type="button" class="btn btn-secondary" onclick="window.location.href='<?php echo site_url('sispek/mitra/'); ?>'">Batal</button>
                                 </div>
                         </form>
