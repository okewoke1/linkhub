  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
      <div class="btn-group mr-2" role="group" aria-label="First group">
        ...
        <button disabled type="button" class="btn btn-info" onclick="window.location.href='<?php echo base_url('sispek/daftarkegiatan'); ?>'">
          <i class="fas fa-chart-pie"></i> Daftar Kegiatan
        </button>
        <button type="button" class="btn btn-info" onclick="window.location.href='<?php echo base_url('sispek/daftarbast'); ?>'">
  ...
  <div class="card shadow mb-4">
    <div class="card-body">
      <div class="table-responsive">
        ...
        <form method="get" action="<?php echo base_url('sispek/daftarkegiatan'); ?>" id="filterForm" class="form-inline mb-4">
          ...
          <tbody>
            <?php foreach ($dataspk as $row) : ?>
              <tr>
                ...
                <td>
                  <a href="<?php echo base_url('sispek/daftarspk/detail/') . substr($row->no_spk, 0, 4) . "-" . date('d-m-Y', strtotime($row->tanggal_spk)); ?>">
                    <?php echo $row->no_spk; ?>
                  </a>
                </td>
                ...
                <td>
                  <div class="row no-gutters">
                    ...
                    <div class="col-md-12 pr-1 mb-1">
                      <!-- Tombol cetak SPK -->
                      <a title="Cetak SPK" href="<?php echo base_url('sispek/daftarspk/cetak_spk/') . substr($row->no_spk, 0, 4) . "-" . date('d-m-Y', strtotime($row->tanggal_spk)); ?>" class="btn btn-info btn-sm btn-block" target="_blank">
