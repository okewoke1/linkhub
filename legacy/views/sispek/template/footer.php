    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="<?php echo site_url('sispek/login/logout'); ?>">Logout</a>
            </div>
        </div>
    </div>
</div>
...
<script src="<?php echo base_url() ?>/assets/sispek/vendor/jquery/jquery.min.js"></script>
<script src="<?php echo base_url() ?>/assets/sispek/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

<!-- Core plugin JavaScript-->
<script src="<?php echo base_url() ?>/assets/sispek/vendor/jquery-easing/jquery.easing.min.js"></script>

<!-- Custom scripts for all pages-->
<script src="<?php echo base_url() ?>/assets/sispek/js/sb-admin-2.min.js"></script>
<script src="<?php echo base_url() ?>/assets/sispek/vendor/datatables/jquery.dataTables.min.js"></script>
<script src="<?php echo base_url() ?>/assets/sispek/vendor/datatables/dataTables.bootstrap4.min.js"></script>
<script src="<?php echo base_url() ?>/assets/sispek/js/demo/datatables-demo.js"></script>

<script src="<?php echo base_url() ?>/assets/sispek/js/"></script>


<!-- SweetAlert2 -->
<script src="<?php echo base_url() ?>/assets/sispek/sweetalert2/sweetalert2.min.js"></script>
<script src="<?php echo base_url() ?>/assets/sispek/toastr/toastr.min.js"></script>
...
<!-- SCRIPT CIPTAAN -->
<script src="<?php echo base_url() ?>/assets/sispek/js/autocomplete.js"></script>
...
<style>
    ...
    .swal-custom-popup {
        font-size: 14px;
        /* Menentukan ukuran font yang lebih kecil */
    }
    ...
    .swal-custom-title {
        ...
        font-weight: bold;
        /* Mengatur ketebalan font judul */
    }

    .swal-custom-html {
        overflow-x: auto;
        /* Agar tabel tidak melampaui batas */
    }
</style>
...
<style>
    ...
    .list-group {
        ...
        /* Tambahkan border untuk visibilitas */
        background-color: white;
        /* Warna latar belakang */
        position: absolute;
        /* Posisi di bawah input */
        width: calc(29%);
        /* Sesuaikan lebar sesuai dengan textbox */
    ...
    $(document).ready(function() {
        ...
        $("#nama_mitra").on("input", function() {
            ...
            if (query.length >= 2) {
                ...
                $.ajax({
                    url: '<?php echo site_url("sispek/kontrak/autocomplete"); ?>', // Endpoint untuk mencari mitra
                    method: "GET",
                    data: {
                        query: query,
                    },
...
<script>
    $(document).ready(function() {
        $('#uploadForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '<?php echo base_url('sispek/mitra/import_mitra'); ?>',
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: "<?php echo base_url('sispek/kontrak/tampil_kelompok_anggaran'); ?>",
            method: 'GET',
            dataType: 'json',
            success: function(response) {
        ...
        $('#kelompok_anggaran').change(function() {
            ...
            $.ajax({
                url: "<?php echo base_url('sispek/kontrak/tampil_kegiatan_by_kelompok_anggaran'); ?>",
                method: 'POST',
                data: {
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#uraian_tugas').change(function() {
            ...
            if (id_tugas != '') {
                $.ajax({
                    url: "<?php echo base_url() ?>sispek/kontrak/autofill_tugas",
                    method: "POST",
                    data: {
                        id_tugas: id_tugas,
...
<script>
    $(document).ready(function() {
        $('#simpan').click(function() {
            ...
            $.ajax({
                url: "<?php echo base_url('sispek/kontrak/simpan_data'); ?>",
                method: 'post',
                data: {
                    t_spk: t_spk,
                    t_idmitra: t_idmitra,
...
<script>
    $(document).ready(function() {
        function tampilkanData(keyword) {
            $.ajax({
                url: "<?php echo base_url('sispek/kontrak/tampil_data'); ?>",
                method: 'post',
                data: {
                    keyword: keyword
                },
        ...
        $(document).on('click', '.btn-hapus', function() {
            ...
            if (confirm('Apakah Anda yakin ingin menghapus data ini?')) {
                $.ajax({
                    url: '<?php echo base_url('sispek/kontrak/hapus_data'); ?>',
                    method: 'post',
                    data: {
                        no_spk: noSpk,
                        id_tugas: idTugas
...
<script>
    $(document).ready(function() {
        $('#generate').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("sispek/kontrak/generate"); ?>',
                type: 'POST',
                dataType: 'json',
                data: {
                    ...
                    if (response.error) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                var editUrl = '<?php echo base_url("sispek/daftarspk/edit_spk/"); ?>' +
...
<script>
    ...
    function simpan_spk() {
        ...
        $.ajax({
            url: '<?php echo base_url("sispek/kontrak/simpan_spk"); ?>',
            type: 'POST',
            dataType: 'json',
            data: {
                no_spk: no_spk,
            ...
            success: function(response) {
                if (response.status == 'success') {
                    ...
                    //     setTimeout(function() {
                    //         window.location.href = "<?php echo site_url('sispek/sispek/daftarspk'); ?>";
                    //     }, 1000);
                    // }
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status == 'success') {
                    toastr.success('Data berhasil disimpan.');
                    isDataUnsaved = false; // Reset the unsaved data flag
                    window.location.href = "<?php echo site_url('sispek/daftarspk/detail/'); ?>" + no_spk4;
                } else {
...
<script>
    function batalSPK() {
        ...
        if (confirm('Apakah Anda yakin ingin membatalkan SPK dengan nomor: ' + no_spk + '?')) {
            $.ajax({
                url: '<?php echo base_url("sispek/kontrak/hapus_spk"); ?>', // Sesuaikan URL dengan endpoint hapus SPK
                type: 'POST',
                dataType: 'json',
                data: {
                    no_spk: no_spk
    ...
    $(document).ready(function() {
        $('#kelompok_anggaran').change(function() {
            ...
            if (kelompok_anggaran != '') {
                $.ajax({
                    url: "<?php echo base_url() ?>sispek/kegiatan/autofill_kode_anggaran",
                    method: "POST",
                    data: {
                        kelompok_anggaran: kelompok_anggaran
                    },
...
<script>
    $(document).ready(function() {
        $('#formTambahAnggaran').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('sispek/anggaran/tambah_aksi'); ?>",
                data: {
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        window.location.href = "<?php echo site_url('sispek/anggaran/index'); ?>"; // Redirect ke halaman daftar anggaran
...
<script>
    $(document).ready(function() {
        ...
        $('#modalEdit').on('submit', '#formEditAnggaran', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('sispek/anggaran/edit_anggaran'); ?>",
                data: {
                    kode_lama: kode_lama,
                    kode: kode,
                    kelompok: kelompok,
...
<script>
    $(document).ready(function() {
        $('#formTambahPPK').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('sispek/ppk/tambah_aksi'); ?>",
                data: {
                    nip: nip,
                    ppk: ppk
                },
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        // Tambahkan kode sukses di sini, misalnya tampilkan pesan sukses
                        toastr.success('Data berhasil ditambahkan!');
                        window.location.href = "<?php echo site_url('sispek/ppk/index'); ?>"; // Redirect ke halaman daftar anggaran
                    } else if (response.status === 'error') {
                        // Tampilkan pesan error
                        toastr.error(response.message);
                    }
...
<script>
    $(document).ready(function() {
        ...
        $('#modalEdit').on('submit', '#formEditPPK', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('sispek/ppk/edit_ppk'); ?>",
                data: {
                    nip_lama: nip_lama,
                    nip: nip,
                    ppk: ppk
...
<script>
    ...
    function cek_ketersediaan_bast(no_spk) {
        $.ajax({
            url: '<?php echo base_url("sispek/daftarspk/cek_bast"); ?>', // URL ke fungsi backend untuk cek BAST
            type: 'POST',
            dataType: 'json',
            data: {
                no_spk: no_spk
    ...
    function hapus_daftarspk(no_spk) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '<?php echo base_url("sispek/daftarspk/hapus_daftarspk"); ?>', // Sesuaikan URL dengan endpoint hapus SPK
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        no_spk: no_spk
...
<script>
    $(document).ready(function() {
        $('#formTambahUser').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('sispek/user/tambah_aksi'); ?>",
                data: {
                    username: username,
                    password: password,
                    level: level,
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        // Tambahkan kode sukses di sini, misalnya tampilkan pesan sukses
                        toastr.success('Data berhasil ditambahkan!');
                        window.location.href = "<?php echo site_url('sispek/user/index'); ?>"; // Redirect ke halaman daftar anggaran
                    } else if (response.status === 'error') {
                        // Tampilkan pesan error
                        toastr.success(response.message);
                    }
...
<script>
    $(document).ready(function() {
        ...
        $('#modalEdit').on('submit', '#formEditUser', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('sispek/user/edit_user'); ?>",
                data: {
                    id: id,
                    username: username,
                    level: level,
    ...
    $(document).on('click', '.btn-edit_PW', function() {
        ...
        $('#modalEdit').on('submit', '#formEditPW', function(e) {
            ...
            if (password !== confirmPassword) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('sispek/user/ganti_password'); ?>",
                    data: {
                        id: id,
                        password: password
                    },
...
<script>
    function cekBAST(no_spk) {
        ...
        $.ajax({
            url: '<?php echo base_url("sispek/daftarbast/cek_bast"); ?>',
            type: 'POST',
            data: {
                no_spk: no_spk
            },
            ...
            success: function(response) {
                ...
                if (response.exists) {
                    ...
                    window.open('<?php echo base_url("sispek/daftarbast/cetak_bast/"); ?>' + response.no_bast + '/' + response.tanggal_spk, '_blank');
...
<script>
    $(document).ready(function() {
        $('#simpanBAST').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("sispek/daftarbast/simpan_bast"); ?>',
                type: 'POST',
                data: {
                    no_spk: no_spk,
                    no_bast: no_bast,
                ...
                success: function(response) {
                    ...
                    window.open('<?php echo base_url("sispek/daftarbast/cetak_bast/"); ?>' + no_bast_substring + '/' + tanggal_spk, '_blank');
    ...
    $(document).on('click', '.btn-hapusbast', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: '<?= base_url("sispek/daftarbast/hapus_bast") ?>', // Ganti dengan URL yang sesuai
                    type: 'POST',
                    data: {
                        no_bast: encoded_no_bast
                    },
                    dataType: 'json',
                    success: function(response) {
                        if (response.status === 'success') {
