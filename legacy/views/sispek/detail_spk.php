                    ...
                    <?php foreach ($spk as $row) : ?>
                        <div class="card shadow mb-4 d-sm-flex">
                            ...
                            <div class="text-right">
                                ...
                                <a title="Edit" href="<?php echo base_url('sispek/daftarspk/edit_spk/') . substr($row->no_spk, 0, 4). "-" . date('d-m-Y', strtotime($row->tanggal_spk)); ?>" class="btn btn-success">
                                    <i class="far fa-edit"></i> Edit
                                </a>

                                <a title="Cetak / Print" href="<?php echo base_url('sispek/daftarspk/cetak_spk/') . substr($row->no_spk, 0, 4) . "-" . date('d-m-Y', strtotime($row->tanggal_spk)); ?>" class="btn btn-danger" target="_blank">
