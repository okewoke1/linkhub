  ...
  <h1 class="h3 mb-0 text-gray-800">DAFTAR SPK</h1>
    <div class="btn-toolbar mb-3" role="toolbar" aria-label="Toolbar with button groups">
      <div class="btn-group mr-2" role="group" aria-label="First group">
        ...
        <button disabled type="button" class="btn btn-info" onclick="window.location.href='<?php echo base_url('sispek/daftarspk'); ?>'">
  ...
  <div class="card shadow mb-4">
    <div class="card-body">
      <div class="table-responsive">
        ...
        <form method="get" action="<?php echo base_url('sispek/daftarspk'); ?>" id="filterForm" class="form-inline mb-4">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-6 pr-1 mb-1">
                            ...
                            <a title="View" class="btn btn-primary btn-sm btn-block btn-view" 
                               ...
                               href="<?php echo base_url('sispek/daftarspk/detail/') . substr($row->no_spk, 0, 4) . "-" . date('d-m-Y', strtotime($row->tanggal_spk)); ?>">
                                <!--<i class="fa fa-eye"></i>-->
                        ...
                        <div class="col-md-6 pl-1 mb-1">
                            <!-- Tombol cetak SPK -->
                            <a title="Cetak SPK" href="<?php echo base_url('sispek/daftarspk/cetak_spk/') . substr($row->no_spk, 0, 4) . "-" . date('d-m-Y', strtotime($row->tanggal_spk)); ?>" 
