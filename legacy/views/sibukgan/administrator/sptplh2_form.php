...
<div class="card-header">
		<a href="<?php echo site_url('sibukgan/administrator/sptplh2/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
</div>

<div class="card-body">
	<form action="<?php echo base_url('sibukgan/administrator/sptplh2/add') ?>" method="post" class="form-row">
		...
		<div class="form-group col-md-6">
			...
			<input name="nip" id="nip" class="form-control" readonly>	
		</div>

        <div class="form-group col-md-6">
			<label class="form-label">NIP</label>
			<input name="nip_1" id="nip_1" class="form-control" readonly>
		</div>
		...
		<div class="form-group col-md-6">
			<label class="form-label">Jabatan</label>
			<input name="jabatan_1" id="jabatan_1" class="form-control " readonly>
		</div>
        ...
        <div class="form-group col-md-6">
			<label class="form-label">Pangkat</label>
			<input class="form-control "
			name="pangkat_1" id="pangkat_1" readonly/>
		</div>
        ...
        <div class="form-group col-md-6">
			<label class="form-label">Golongan</label>
			<input class="form-control "
			name="golongan_1" id="golongan_1" readonly/>
		</div>
