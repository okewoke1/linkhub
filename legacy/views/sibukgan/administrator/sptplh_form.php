...
<div class="card-header">
		<a href="<?php echo site_url('sibukgan/administrator/sptplh/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
</div>

<div class="card-body">
	<form action="<?php echo base_url('sibukgan/administrator/sptplh/add') ?>" method="post" class="form-row">
