...
<div class="card-header">
		<a href="<?php echo site_url('sibukgan/administrator/spt/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
</div>
	...
	<form action="" method="post" class="row g-3">
      ...
      <div class="form-group col-md-1">
		...
		<div class="form-group col-md-2">
			...
			<select id="nomor" class="form-control <?php echo form_error('nomor') ? 'is-invalid':'' ?>" name="nomor" value="">
