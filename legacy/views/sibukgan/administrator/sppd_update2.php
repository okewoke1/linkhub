...
<div class="card-header">
		<a href="<?php echo site_url('sibukgan/administrator/sppd/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
</div>
...
<!-- 		<div class="col-md-6">
		...
		<div class="col-md-6">
			...
			type="date" name="tgl_spd" value="<?php echo $sppd->tgl_spd ?>"/>
			<div class="invalid-feedback">
...
<!-- 		<div class="col-md-6">
			...
			<option><?php echo $sppd->kegiatan ?></option>
...
<!-- 		<div class="col-md-6">
			...
			type="date" name="tgl_berangkat" value="<?php echo $sppd->tgl_berangkat ?>"/>
			<div class="invalid-feedback">
...
<!-- 		<div class="col-md-6">
			...
			<option><?php echo $sppd->program ?></option>
			...
			type="date" name="tgl_kembali" value="<?php echo $sppd->tgl_kembali ?>"/>
			<div class="invalid-feedback">
			...
			<option><?php echo $sppd->komponen ?></option>
		...
		<div class="col-md-6">
			...
			<option><?php echo $sppd->output ?></option>
			...
			<label for="tujuan">Tujuan</label>
			  <input list="list" name="tujuan" id="tujuan" class="form-control <?php echo form_error('mata_anggaran') ? 'is-invalid':'' ?> mb-3" value="<?php echo $sppd->tujuan ?>">
  			<datalist id="list">
   			<?php                                
			...
			<option><?php echo $sppd->mata_anggaran ?></option>
...
<!-- 				<div class="col-md-6">
			...
			<option><?php echo $sppd->jenis_transport ?></option>
			<option>Dinas</option>
		...
		<div class="col-md-6">
			...
			<option value="3">Edit SPD</option>
			</select>
			<div class="invalid-feedback">
