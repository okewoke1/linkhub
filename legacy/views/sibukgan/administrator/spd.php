...
foreach ($spt as $st) :
      ...
      ?>
		 	...
		 	<td width="20px">
			 <a href="<?php echo base_url('sibukgan/administrator/spd/cetak_spd/'.$st->id_spt) ?>" target="_blank"><abbr title="cetak spd"><div class="btn btn-sm btn-success"><i class="fas fa-print"></i></div></abbr></a>
