...
<?php echo anchor('sibukgan/user/spt/add','<button class="btn btn-sm btn-primary mb-3"><i class="fas fa-plus fa-sm"></i> Buat ST</button>') ?>
...
foreach ($spt as $st) :
      ...
      ?>
		 	...
		 	<td width="20px">
		 	<a href="<?php echo base_url('sibukgan/user/spt/cetak_spt/'.$st->id_spt) ?>" target="_blank"><abbr title="cetak spt"><div class="btn btn-sm btn-primary"><i class="fas fa-print"></i></div></abbr></a>
