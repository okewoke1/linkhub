...
<?php echo anchor('sibukgan/user/sptplh2/add','<button class="btn btn-sm btn-primary mb-3"><i class="fas fa-plus fa-sm"></i> Buat ST 2 Pegawai (PLH)</button>') ?>
...
foreach ($spt as $st) :
      ...
      ?>
		 	...
		 	<td><a href="<?php echo base_url('sibukgan/user/sptplh2/cetak_sptplh2/'.$st->id_spt) ?>" target="_blank"><abbr title="cetak spt"><div class="btn btn-sm btn-primary"><i class="fas fa-print"></i></div></abbr></a>
