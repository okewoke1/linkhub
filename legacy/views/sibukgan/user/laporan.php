...
foreach ($laporan as $st) :
      ...
      ?>
		 	...
		 	<td width="20px" class="text-center"><abbr title="download"><a href="<?php echo base_url().'sibukgan/user/laporan/download/'.$st->id_spt; ?>" target="_blank" class="btn btn-success btn-sm"><i class="fa fa-download"></i></a></abbr></td>
		 	<td width="20px">				
		 		<?php
