...
foreach ($spt as $st) :
      ...
      ?>
           <td>B-<?php echo $st->no ?>/6109<?php echo $st->nomor ?>/<?php echo $st->kode_huruf ?>/<?php echo ($thn1);?></td>
		 	...
		 	<td width="20px">
			 <a href="<?php echo base_url('sibukgan/user/spd/cetak_spd/'.$st->id_spt) ?>" target="_blank"><abbr title="cetak spd"><div class="btn btn-sm btn-success"><i class="fas fa-print"></i></div></abbr></a>
			</td>
		 </tr>
		<?php endforeach; ?>
	</tbody>
