...
<?php echo anchor('sibukgan/user/sptplh/add','<button class="btn btn-sm btn-primary mb-3"><i class="fas fa-plus fa-sm"></i> Buat ST (PLH)</button>') ?>
...
foreach ($spt as $st) :
      ...
      ?>
		 	...
		 	<a href="<?php echo base_url('sibukgan/user/sptplh/cetak_sptplh/'.$st->id_spt) ?>" target="_blank"><abbr title="cetak spt"><div class="btn btn-sm btn-primary"><i class="fas fa-print"></i></div></abbr></a>
