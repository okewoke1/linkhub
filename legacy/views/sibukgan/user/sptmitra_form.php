...
<div class="card-header">
		<a href="<?php echo site_url('sibukgan/user/sptmitra/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
</div>

<div class="card-body">
	<form action="<?php echo base_url('sibukgan/user/sptmitra/add') ?>" method="post" class="form-row">
		...
		<div class="form-group col-md-6">
           ...
           <?php foreach ($kd as $data) :
			...
			$kd = sprintf($a);
		 ?>
			<input type="text" name="no" class="form-control <?php echo form_error('no') ? 'is-invalid':'' ?> " value="<?php echo $kd ?>" readonly>
			<div class="invalid-feedback">
