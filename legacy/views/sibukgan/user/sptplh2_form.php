...
<div class="card-header">
		<a href="<?php echo site_url('sibukgan/user/sptplh2/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
</div>

<div class="card-body">
	<form action="<?php echo base_url('sibukgan/user/sptplh2/add') ?>" method="post" class="form-row">
