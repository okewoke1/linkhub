...
<head>
    ...
    <link href="<?php echo base_url('assets/sibukgan/fontawesome-free/css/all.min.css') ?>" rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="<?php echo base_url('assets/sibukgan/css/sb-admin-2.min.css') ?>" rel="stylesheet">
    <style>
        body {
            background-image: url("<?php echo base_url('assets/sibukgan/img/bg1.JPG'); ?>");
        ...
        div.p-5 {
            background-image: url("<?php echo base_url('assets/sibukgan/img/bg.jpg'); ?>");
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form method="post" action="<?php echo base_url('sibukgan/login') ?>" class="user">
