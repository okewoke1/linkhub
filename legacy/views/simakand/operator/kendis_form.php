...
<div class="card-header">
		<a href="<?php echo site_url('simakand/operator/kendis/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
</div>

<div class="card-body">
<form action="<?php base_url("simakand/operator/kendis/edit") ?>" method="post" class="row g-3">
