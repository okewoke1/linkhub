...
<div class="card-header">
		<a href="<?php echo site_url('simakand/administrator/bbm/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
</div>

<div class="card-body">
<form action="<?php base_url("simakand/administrator/bbm/edit") ?>" method="post" class="row g-3">
