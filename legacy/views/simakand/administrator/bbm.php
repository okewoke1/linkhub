...
foreach ($bbm as $st) :
		...
		<tr>
			...
			<td width="140px">
			<abbr title="download"><a href="<?php echo base_url().'simakand/administrator/bbm/download/'.$st->id_upload; ?>" target="_blank" class="btn btn-success btn-sm"><i class="fa fa-download"></i></a></abbr>
			<!-- <button type="button" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#editModal <?php echo $st->id_upload?>">
			<i class="fa fa-edit" ></i>
</button> -->

			<abbr title="edit" ><?php echo anchor('simakand/administrator/bbm/edit/'.$st->id_upload,'<div class="btn btn-sm btn-warning"><i class="fa fa-edit" ></i></div>') ?></abbr>
			<abbr title="delete"><a onclick="deleteConfirm('<?php echo site_url('simakand/administrator/bbm/delete/'.$st->id_upload) ?>')" class="btn btn-sm btn-danger" href="#!" ><i class="fas fa-trash"></i></a></abbr></td>
