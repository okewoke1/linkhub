...
<div class="card-header">
		<a href="<?php echo site_url('simakand/user/kendis/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
</div>

<div class="card-body">
	<!-- <form action="<?php echo base_url('simakand/user/kendis/add') ?>" method="post"   enctype="multipart/form-data" class="form-row"> -->
	<?php echo form_open_multipart('simakand/user/kendis/add');?>
