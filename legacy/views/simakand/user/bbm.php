...
foreach ($bbm as $st) :
		...
		<tr>
			...
			<td width="20px">
			<!-- <abbr title="edit" ><?php echo anchor('simakand/user/bbm/edit/'.$st->id_upload,'<div class="btn btn-sm btn-warning" ><i class="fa fa-edit" ></i></div>') ?></abbr> -->
			<abbr title="delete"><a onclick="deleteConfirm('<?php echo site_url('simakand/user/bbm/delete/'.$st->id_upload) ?>')" class="btn btn-sm btn-danger" href="#!" ><i class="fas fa-trash"></i></a></abbr></td>
