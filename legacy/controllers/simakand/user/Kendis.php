...
class Kendis extends CI_Controller
{
    ...
    public function upload()
    {
        ...
        if ($file=''){}else{
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                $this->Kendis_modeluser->input_data($data, 'tb_kendis');
                redirect('simakand/user/kendis');
    }
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Kendis_modeluser->delete($id)) {
            redirect(site_url('simakand/user/kendis'));
        }
    }
