...
class Kendis extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('simakand/operator/kendis', $data);
    ...
    public function upload()
    {
        ...
        if ($file=''){}else{
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                redirect('simakand/operator/kendis');
    }
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Kendis_modeloperator->delete($id)) {
            redirect(site_url('simakand/operator/kendis'));
        }
    }
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('simakand/operator/kendis');
        ...
        $this->load->view('simakand/template_operator/header');
        $this->load->view('simakand/template_operator/sidebar',$data);
        $this->load->view('simakand/operator/kendis_form',$data);
        $this->load->view('simakand/template_operator/footer');
    }
