...
class Kendis extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['user'] = $this->db->get_where('tb_user',['nip' => $this->session->userdata('nip')])->row_array();
        $nip = $data['nip'];
        $data['kendis'] = $this->Kendis_modeladmin->tampil_data($nip);
        

        $this->load->view('simakand/template_administrator/header');
        $this->load->view('simakand/template_administrator/sidebar',$data);
        $this->load->view('simakand/administrator/kendis', $data);
        $this->load->view('simakand/template_administrator/footer');
    }
    ...
    public function upload()
    {
        ...
        if ($file=''){}else{
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                redirect('simakand/administrator/kendis');
    }
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Kendis_modeladmin->delete($id)) {
            redirect(site_url('simakand/administrator/kendis'));
        }
    }
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('simakand/administrator/kendis');
        ...
        $this->load->view('simakand/template_administrator/header');
        $this->load->view('simakand/template_administrator/sidebar',$data);
        $this->load->view('simakand/administrator/kendis_form',$data);
        $this->load->view('simakand/template_administrator/footer');
    }
