...
class Bbm extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('simakand/administrator/bbm', $data);
    ...
    public function upload()
    {
        ...
        if ($file=''){}else{
            ...
            if (!$this->upload->do_upload('userfile')) {
                ...
                redirect('simakand/administrator/bbm');
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Bbm_modeluser->delete($id)) {
            redirect(site_url('simakand/administrator/bbm'));
        }
    }
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('simakand/administrator/bbm');
        ...
        $this->load->view('simakand/template_administrator/header');
        $this->load->view('simakand/template_administrator/sidebar',$data);
        $this->load->view('simakand/administrator/bbm_form',$data);
        $this->load->view('simakand/template_administrator/footer');
    }
