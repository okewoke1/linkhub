...
class Daftarspk extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($level == '1') {
            ...
            $this->load->view('sispek/daftarspk', $data);
    ...
    public function detail($no_spk)
    {
        ...
        if ($level == '1') {
            $this->load->view('sispek/template/header');
            $this->load->view('sispek/template/sidebar_adm', $data);
            $this->load->view('sispek/detail_spk', $data);
            $this->load->view('sispek/template/footer');
        } else if ($level == '2') {
            $this->load->view('sispek/template/header');
            $this->load->view('sispek/template/sidebar', $data);
    ...
    //     // $this->load->view('sispek/cetak_bast');
    ...
    public function cetak_spk($no_spk)
    {
        ...
        $this->load->view('sispek/cetak_spk', $data);
    }
    ...
    public function hapus_daftarspk()
    {
        ...
        // redirect('sispek/daftarspk/index');
    }
    ...
    public function edit_spk($no_spk)
    {
        ...
        if ($level == '1') {
            $this->load->view('sispek/template/header');
            $this->load->view('sispek/template/sidebar_adm', $data);
            $this->load->view('sispek/edit_spk', $data);
            $this->load->view('sispek/template/footer');
        } else if ($level == '2') {
            $this->load->view('sispek/template/header');
            $this->load->view('sispek/template/sidebar', $data);
