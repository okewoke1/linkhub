...
class Biaya extends CI_Controller
{
    ...
    $nip = $data['nip'];
		...
		$this->load->view('sibukgan/administrator/biaya', $data);
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('sibukgan/administrator/biaya');
        ...
        $this->load->view('sibukgan/template_administrator/header');
        $this->load->view('sibukgan/template_administrator/sidebar',$data);
        $this->load->view('sibukgan/administrator/biaya_form',$data);
        $this->load->view('sibukgan/template_administrator/footer');
    }
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Spt_model->delete($id)) {
            redirect(site_url('sibukgan/administrator/biaya'));
        }
    }
    ...
    public function cetak_biaya($id)
    {
        ...
        $this->load->view('sibukgan/administrator/cetak_biaya', $data);
    }
