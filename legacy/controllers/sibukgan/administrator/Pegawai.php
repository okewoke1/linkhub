...
class Pegawai extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('sibukgan/administrator/pegawai',$data);
	...
	public function add()
    {
        ...
        if ($validation->run()) {
            $pegawai->save();
            redirect('sibukgan/administrator/pegawai');        }
        
		$this->load->view('sibukgan/template_administrator/header');
		$this->load->view('sibukgan/template_administrator/sidebar',$data);
		$this->load->view('sibukgan/administrator/pegawai_form',$data);
		$this->load->view('sibukgan/template_administrator/footer');
    }
	...
	public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('sibukgan/administrator/pegawai');
        ...
        $this->load->view('sibukgan/template_administrator/header');
		$this->load->view('sibukgan/template_administrator/sidebar',$data);
		$this->load->view('sibukgan/administrator/pegawai_update',$data);
		$this->load->view('sibukgan/template_administrator/footer');
    }
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Pegawai_model->delete($id)) {
            redirect(site_url('sibukgan/administrator/pegawai'));
        }
    }
