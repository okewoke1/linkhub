...
class Sptmitra extends CI_Controller
{
    ...
    public function index()
    {
		...
		$this->load->view('sibukgan/administrator/sptmitra', $data);
    ...
    public function add()
    {
        ...
        if ($validation->run()) {
            $sptmitra->save();
            redirect('sibukgan/administrator/sptmitra');
        }
        
		$this->load->view('sibukgan/template_administrator/header');
		$this->load->view('sibukgan/template_administrator/sidebar',$data);
		$this->load->view('sibukgan/administrator/sptmitra_form',$data);
		$this->load->view('sibukgan/template_administrator/footer');
    }
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Spt_modelmitra->delete($id)) {
            redirect(site_url('sibukgan/administrator/sptmitra'));
        }
    }
    ...
    public function cetak_sptmitra($id)
    {
        ...
        $this->load->view('sibukgan/administrator/cetak_sptmitra', $data);
    }
