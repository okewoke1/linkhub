...
class Sptplh extends CI_Controller
{
    ...
    public function index()
    {
		...
		$this->load->view('sibukgan/administrator/sptplh', $data);
    ...
    public function add()
    {
        ...
        if ($validation->run()) {
            $spt->save();
            redirect('sibukgan/administrator/sptplh');
        }
        
		$this->load->view('sibukgan/template_administrator/header');
		$this->load->view('sibukgan/template_administrator/sidebar',$data);
		$this->load->view('sibukgan/administrator/sptplh_form',$data);
		$this->load->view('sibukgan/template_administrator/footer');
    }
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('sibukgan/administrator/sptplh');
        ...
        $this->load->view('sibukgan/template_administrator/header');
        $this->load->view('sibukgan/template_administrator/sidebar',$data);
        $this->load->view('sibukgan/administrator/sptplh_update',$data);
        $this->load->view('sibukgan/template_administrator/footer');
    }
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Sptplh_model->delete($id)) {
            redirect(site_url('sibukgan/administrator/sptplh'));
        }
    }
    ...
    public function cetak_sptplh($id)
    {
        ...
        $this->load->view('sibukgan/administrator/cetak_sptplh', $data);
    }
