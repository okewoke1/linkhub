...
class Sptplh extends CI_Controller
{
    ...
    public function index()
    {
		...
		$this->load->view('sibukgan/user/sptplh', $data);
    ...
    public function add()
    {
        ...
        if ($validation->run()) {
            $spt->save();
            redirect('sibukgan/user/sptplh');
        }
        
		$this->load->view('sibukgan/template_user/header');
		$this->load->view('sibukgan/template_user/sidebar',$data);
		$this->load->view('sibukgan/user/sptplh_form',$data);
		$this->load->view('sibukgan/template_user/footer');
    }
    ...
    public function add2()
    {
        ...
        if ($validation->run()) {
            $spt->save();
            redirect('sibukgan/user/spt');
        }
        
		$this->load->view('sibukgan/template_user/header');
		$this->load->view('sibukgan/template_user/sidebar',$data);
		$this->load->view('sibukgan/user/spt_form2',$data);
		$this->load->view('sibukgan/template_user/footer');
    }
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('sibukgan/user/spt');
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Sptplh_model->delete($id)) {
            redirect(site_url('sibukgan/user/sptplh'));
        }
    }
    ...
    public function cetak_sptplh($id)
    {
        ...
        $this->load->view('sibukgan/user/cetak_sptplh', $data);
    }
