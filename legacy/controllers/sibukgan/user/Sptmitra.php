...
class Sptmitra extends CI_Controller
{
    ...
    public function index()
    {
		...
		$this->load->view('sibukgan/user/sptmitra', $data);
    ...
    public function add()
    {
        ...
        if ($validation->run()) {
            $sptmitra->save();
            redirect('sibukgan/user/sptmitra');
        }
        
		$this->load->view('sibukgan/template_user/header');
		$this->load->view('sibukgan/template_user/sidebar',$data);
		$this->load->view('sibukgan/user/sptmitra_form',$data);
		$this->load->view('sibukgan/template_user/footer');
    }
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Spt_modelmitra->delete($id)) {
            redirect(site_url('sibukgan/user/sptmitra'));
        }
    }
    ...
    public function cetak_sptmitra($id)
    {
        ...
        $this->load->view('sibukgan/user/cetak_sptmitra', $data);
    }
