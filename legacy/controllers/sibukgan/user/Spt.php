...
class Spt extends CI_Controller
{
    ...
    public function index()
    {
		...
		$this->load->view('sibukgan/user/spt', $data);
    ...
    //   	$data['kd'] = $this->Spt_model->auto_code();
		...
		$this->load->view('sibukgan/template_user/header');
		$this->load->view('sibukgan/template_user/sidebar',$data);
		$this->load->view('sibukgan/user/spt_form',$data);
		$this->load->view('sibukgan/template_user/footer');
    }
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Spt_model->delete($id)) {
            redirect(site_url('sibukgan/user/spt'));
        }
    }
    ...
    public function cetak_spt($id)
    {
        ...
        $this->load->view('sibukgan/user/cetak_spt', $data);
    }
