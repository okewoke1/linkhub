...
class Biaya extends CI_Controller
{
    ...
    $nip = $data['nip'];
		...
		$this->load->view('sibukgan/user/biaya', $data);
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('sibukgan/user/biaya');
        ...
        $this->load->view('sibukgan/template_user/header');
        $this->load->view('sibukgan/template_user/sidebar',$data);
        $this->load->view('sibukgan/user/biaya_form',$data);
        $this->load->view('sibukgan/template_user/footer');
    }
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Spt_model->delete($id)) {
            redirect(site_url('sibukgan/user/biaya'));
        }
    }
    ...
    public function cetak_biaya($id)
    {
        ...
        $this->load->view('sibukgan/user/cetak_biaya', $data);
    }
