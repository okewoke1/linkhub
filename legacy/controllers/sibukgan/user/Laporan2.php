...
class Laporan2 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('sibukgan/user/laporan2', $data);
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('sibukgan/user/laporan2');
        ...
        $this->load->view('sibukgan/template_user/header');
        $this->load->view('sibukgan/template_user/sidebar',$data);
        $this->load->view('sibukgan/user/laporanadmin_form',$data);
        $this->load->view('sibukgan/template_user/footer');
    }
        ...
        public function edit2($id = null)
    {
        ...
        $this->load->view('sibukgan/template_user/header');
        $this->load->view('sibukgan/template_user/sidebar',$data);
        $this->load->view('sibukgan/user/laporan_editadmin',$data);
        $this->load->view('sibukgan/template_user/footer');
    }
