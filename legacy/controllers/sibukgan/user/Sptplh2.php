...
class Sptplh2 extends CI_Controller
{
    ...
    public function index()
    {
		...
		$this->load->view('sibukgan/user/spt2plh', $data);
    ...
    public function add()
    {
        ...
        if ($validation->run()) {
            $spt->save();
            redirect('sibukgan/user/sptplh2');
        }
        
		$this->load->view('sibukgan/template_user/header');
		$this->load->view('sibukgan/template_user/sidebar',$data);
		$this->load->view('sibukgan/user/sptplh2_form',$data);
		$this->load->view('sibukgan/template_user/footer');
    }
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('sibukgan/user/sptplh2');
        ...
        $this->load->view('sibukgan/template_user/header');
        $this->load->view('sibukgan/template_user/sidebar',$data);
        $this->load->view('sibukgan/user/spt_update',$data);
        $this->load->view('sibukgan/template_user/footer');
    }
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Sptplh2_model->delete($id)) {
            redirect(site_url('sibukgan/user/sptplh2'));
        }
    }  
    ...
    public function cetak_sptplh2($id)
    {
        ...
        $this->load->view('sibukgan/user/cetak_sptplh2', $data);
    }
