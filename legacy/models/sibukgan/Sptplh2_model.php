...
class Sptplh2_model extends CI_Model
{	
    ...
    {
        return $this->db->query('SELECT * FROM  tb_spt WHERE status_plh IS NOT NULL AND anggota_1 IS NOT NULL ORDER BY id_spt DESC');
    }
