...
class Sptplh_model extends CI_Model
{	
    ...
    {
        $query = "SELECT * FROM tb_spt WHERE status_plh IS NOT NULL  AND anggota_1 IS NULL ORDER BY id_spt DESC";
