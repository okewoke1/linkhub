...
class Bbm extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('operator/bbm', $data);
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Bbm_modeluser->delete($id)) {
            redirect(site_url('operator/bbm'));
        }
    }
  ...
  public function view($id){
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('operator/bbm');
        ...
        $this->load->view('template_operator/header');
        $this->load->view('template_operator/sidebar',$data);
        $this->load->view('operator/bbm_form',$data);
        $this->load->view('template_operator/footer');
