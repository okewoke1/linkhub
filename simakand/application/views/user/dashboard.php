                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-light text-uppercase mb-1">
                                                Pegawai</div>
                                            <div class="h5 mb-0 font-weight-bold text-light"><?php echo $this->db->query("SELECT id FROM master_users")->num_rows(); ?></div>
                                        </div>
                                        <div class="col-auto">  
...
<div class="col-xl-8 col-lg-4">
    <div class="card shadow mb-2">
        ...
        <div
            ...
            <h6 class="m-0 font-weight-bold text-light">Pengeluaran Total</h6>
        </div>
        <!-- Card Body -->
        <div class="card-body">
