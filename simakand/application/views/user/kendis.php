...
foreach ($kendis as $st) :
		 ...
		 <tr>
		  ...
		  <td width="20px"><!--<abbr title="edit" ><?php echo anchor('user/spt/edit/'.$st->id_kendis,'<div class="btn btn-sm btn-warning" ><i class="fa fa-edit" ></i></div>') ?></abbr> -->
		 	<!-- <a href="<?php echo base_url('user/spt/detail_spt/'.$st->id_kendis) ?>" ><abbr title="detail spt"><div class="btn btn-success btn-icon btn-sm"><i class="fa fa-folder-open"></i></abbr></i></div></a> -->
		 	<!-- <a href="<?php echo base_url('user/spt/cetak_kendis/'.$st->id_kendis) ?>" target="_blank"><abbr title="cetak spt"><div class="btn btn-sm btn-primary"><i class="fas fa-print"></i></abbr></i></div></a> -->
			<abbr title="delete"><a onclick="deleteConfirm('<?php echo site_url('user/kendis/delete/'.$st->id_kendis) ?>')" class="btn btn-sm btn-danger" href="#!" ><i class="fas fa-trash"></i></a></abbr></td>
