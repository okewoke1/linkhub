...
<div class="card-header">
		<a href="<?php echo site_url('user/bbm/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
</div>

<div class="card-body">
<form action="<?php base_url("user/bbm/edit") ?>" enctype="multipart/form-data" method="post" class="row g-3">
