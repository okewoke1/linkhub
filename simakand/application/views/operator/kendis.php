...
foreach ($kendis as $st) :
		 ...
		 <tr>
		  ...
		  <td width="140px">
		  <abbr title="download"><a href="<?php echo base_url().'operator/kendis/download/'.$st->id_kendis; ?>" target="_blank" class="btn btn-success btn-sm"><i class="fa fa-download"></i></a></abbr>

		  <abbr title="edit" ><?php echo anchor('operator/kendis/edit/'.$st->id_kendis,'<div class="btn btn-sm btn-warning" ><i class="fa fa-edit" ></i></div>') ?></abbr>
		 	<!-- <a href="<?php echo base_url('operator/kendis/detail_kendis/'.$st->id_kendis) ?>" ><abbr title="detail kendis"><div class="btn btn-success btn-icon btn-sm"><i class="fa fa-folder-open"></i></abbr></i></div></a> -->
		 	<!-- <a href="<?php echo base_url('operator/kendis/cetak_kendis/'.$st->id_kendis) ?>" target="_blank"><abbr title="cetak spt"><div class="btn btn-sm btn-primary"><i class="fas fa-print"></i></abbr></i></div></a> -->
			<abbr title="delete"><a onclick="deleteConfirm('<?php echo site_url('operator/kendis/delete/'.$st->id_kendis) ?>')" class="btn btn-sm btn-danger" href="#!" ><i class="fas fa-trash"></i></a></abbr></td>
			<td width="20px"><?php
				 if($st->status_post == 0){
...
<?php $this->load->view("operator/modal.php") ?>
