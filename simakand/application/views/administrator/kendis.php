...
foreach ($kendis as $st) :
		 ...
		 <tr>
		  ...
		  <td width="140px">
		  	<abbr title="download"><a href="<?php echo base_url().'administrator/kendis/download/'.$st->id_kendis; ?>" target="_blank" class="btn btn-success btn-sm"><i class="fa fa-download"></i></a></abbr>
			<abbr title="edit" ><?php echo anchor('administrator/kendis/edit/'.$st->id_kendis,'<div class="btn btn-sm btn-warning" ><i class="fa fa-edit" ></i></div>') ?></abbr>
		 	<!-- <a href="<?php echo base_url('administrator/spt/cetak_kendis/'.$st->id_kendis) ?>" target="_blank"><abbr title="cetak spt"><div class="btn btn-sm btn-primary"><i class="fas fa-print"></i></abbr></i></div></a> -->
			<abbr title="delete"><a onclick="deleteConfirm('<?php echo site_url('administrator/kendis/delete/'.$st->id_kendis) ?>')" class="btn btn-sm btn-danger" href="#!" ><i class="fas fa-trash"></i></a></abbr></td>
