...
<body class="index-page">
  ...
  <header id="header" class="header dark-background d-flex flex-column">
    ...
    <div class="profile-img">
      <img src="assets/img/pegawai/RAYYAN.webp" alt="" class="img-fluid rounded-circle">
    </div>

    <a href="index.html" class="logo d-flex align-items-center justify-content-center">
      <!-- Uncomment the line below if you also wish to use an image logo -->
      <!-- <img src="assets/img/logo.png" alt=""> -->
      <h1 class="sitename">Seorang Admin</h1>
    </a>
    ...
    <nav id="navmenu" class="navmenu">
      <ul>
        ...
        <li class="dropdown"><a href="#"><i class="bi bi-link-45deg navicon"></i> <span>Tautan</span> <i
          ...
          <ul>
            ...
            <li><a href="#">Teknis</a></li>
          </ul>
        </li>
        <li><a href="#skp"><i class="bi bi-folder2 navicon"></i> Bukti Dukung SKP</a></li>
        <li class="dropdown"><a href="#"><i class="bi bi-gear navicon"></i> <span>Kelola</span> <i
              class="bi bi-chevron-down toggle-dropdown"></i></a>
          <ul>
            <!-- <li><a href="#">Umum</a></li> -->
            <!-- <li class="dropdown"><a href="#"><span>Deep Dropdown</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            ...
            <li><a href="#">SKP Pegawai</a></li>
            <li><a href="#">Pengumuman</a></li>
          </ul>
        </li>
        <li><a href="#faq"><i class="bi bi-question-circle navicon"></i> FAQ</a></li>
  ...
  <main class="main">
    ...
    <section id="home" class="hero section dark-background">
      ...
      <img src="assets/img/bg.jpg" alt="" data-aos="fade-in" class="">

      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <h2>LEAD BPS Kabupaten Sekadau</h2>
        <p>Linkhub Sumber Daya Digital</p>
      </div>
          ...
          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
              <div class="portfolio-content h-100">
                <img src="assets/img/web-capture/simakand.png" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4>SIMAKAND</h4>
                  <p>Sistem bla, bla, bla...</p>
                  <a href="https://simakand.sekadau6109.com/" title="More Details" class="details-link"><i
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 card-column" data-aos="fade-up" data-aos-delay="100">
            <div class="team-member d-flex align-items-start">
              <div class="pic"><img src="assets/img/pegawai/PAK IMAM.webp" loading="lazy" class="img-fluid"
                  alt=""></div>
              <div class="member-info">
                ...
                <div class="social">
                  <a target="_blank" href="https://drive.google.com/drive/folders/1r_6PQreR9E__4zaBJh3EAWnhAiJXtoDn"
    ...
    <!-- logout Section -->
    <section id="logout" class="about section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-4">
            <img src="assets/img/web-capture/dokumentasi.png" class="img-fluid" alt="">
          </div>
    ...
    <section id="data-table" class="data-table section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>My Data</h2>
          <p>This section displays tabular information using the iPortfolio theme style.</p>
        </div>
    ...
    <!-- faq Section -->
    <section id="faq" class="resume section">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="assets/img/web-capture/dokumentasi.png" class="testimonial-img" alt="">
                <h3>Saul Goodman</h3>
                <h4>Ceo &amp; Founder</h4>
              </div>
