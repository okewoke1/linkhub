...
class Laporan2 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('administrator/laporan2', $data);
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('administrator/laporan2');
        ...
        $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar',$data);
        $this->load->view('administrator/laporanadmin_form',$data);
        $this->load->view('template_administrator/footer');
    }
        ...
        public function edit2($id = null)
    {
        ...
        $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar',$data);
        $this->load->view('administrator/laporan_editadmin',$data);
        $this->load->view('template_administrator/footer');
    }
