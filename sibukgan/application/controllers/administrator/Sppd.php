...
class Sppd extends CI_Controller
{
    ...
    public function index()
    {
		...
		$this->load->view('administrator/sppd', $data);
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('administrator/sppd');
        ...
        $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar',$data);
        $this->load->view('administrator/spt2_update',$data);
        $this->load->view('template_administrator/footer');
    }
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Spt_model2->delete($id)) {
            redirect(site_url('administrator/sppd'));
        }
    }  
    ...
    public function cetak_spt2($id)
    {
        ...
        $this->load->view('administrator/cetak_spt2', $data);
    }
