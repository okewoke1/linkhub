...
class Biaya extends CI_Controller
{
    ...
    $nip = $data['nip'];
		...
		$this->load->view('administrator/biaya', $data);
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('administrator/biaya');
        ...
        $this->load->view('template_administrator/header');
        $this->load->view('template_administrator/sidebar',$data);
        $this->load->view('administrator/biaya_form',$data);
        $this->load->view('template_administrator/footer');
    }
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Spt_model->delete($id)) {
            redirect(site_url('administrator/biaya'));
        }
    }
    ...
    public function cetak_biaya($id)
    {
        ...
        $this->load->view('administrator/cetak_biaya', $data);
    }
