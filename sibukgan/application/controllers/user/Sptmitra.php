...
class Sptmitra extends CI_Controller
{
    ...
    public function index()
    {
		...
		$this->load->view('user/sptmitra', $data);
    ...
    public function add()
    {
        ...
        if ($validation->run()) {
            $sptmitra->save();
            redirect('user/sptmitra');
        }
        
		$this->load->view('template_user/header');
		$this->load->view('template_user/sidebar',$data);
		$this->load->view('user/sptmitra_form',$data);
		$this->load->view('template_user/footer');
    }
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Spt_modelmitra->delete($id)) {
            redirect(site_url('user/sptmitra'));
        }
    }
    ...
    public function cetak_sptmitra($id)
    {
        ...
        $this->load->view('user/cetak_sptmitra', $data);
    }
