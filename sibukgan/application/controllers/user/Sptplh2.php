...
class Sptplh2 extends CI_Controller
{
    ...
    public function index()
    {
		...
		$this->load->view('user/spt2plh', $data);
    ...
    public function add()
    {
        ...
        if ($validation->run()) {
            $spt->save();
            redirect('user/sptplh2');
        }
        
		$this->load->view('template_user/header');
		$this->load->view('template_user/sidebar',$data);
		$this->load->view('user/sptplh2_form',$data);
		$this->load->view('template_user/footer');
    }
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('user/sptplh2');
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Sptplh2_model->delete($id)) {
            redirect(site_url('user/sptplh2'));
        }
    }  
    ...
    public function cetak_sptplh2($id)
    {
        ...
        $this->load->view('user/cetak_sptplh2', $data);
    }
