...
class Laporan2 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('user/laporan2', $data);
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('user/laporan2');
        ...
        $this->load->view('template_user/header');
        $this->load->view('template_user/sidebar',$data);
        $this->load->view('user/laporanadmin_form',$data);
        $this->load->view('template_user/footer');
    }
        ...
        public function edit2($id = null)
    {
        ...
        $this->load->view('template_user/header');
        $this->load->view('template_user/sidebar',$data);
        $this->load->view('user/laporan_editadmin',$data);
        $this->load->view('template_user/footer');
    }
