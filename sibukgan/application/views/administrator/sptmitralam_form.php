...
<div class="card mb-3">
    <div class="card-header">
        <strong>Import Mitra dari Excel</strong>
    </div>
    <div class="card-body">
        <form action="<?= base_url('administrator/sptmitralam/import_excel') ?>"
            ...
            <div class="form-row">
                <div class="form-group col-md-8">
                    ...
                    <small class="text-muted">
                        Format Excel: 1 kolom dengan header <b>mitra</b>
                    </small>
                </div>
    ...
    <div class="card mb-3">
        <div class="card-header">
            <a href="<?php echo site_url('administrator/sptmitralam/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
        </div>

        <div class="card-body">
            <form action="<?php echo base_url('administrator/sptmitralam/add') ?>" method="post" class="form-row">
...
$('#mitra').select2({
    ...
    ajax: {
        url: '<?= base_url('administrator/sptmitralam/get_mitra') ?>',
        dataType: 'json',
        delay: 250,
