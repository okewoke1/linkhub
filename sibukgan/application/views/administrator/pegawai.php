...
<div class="container-fluid">
	...
	<?php echo anchor('administrator/pegawai/add','<button class="btn btn-sm btn-primary mb-3"><i class="fas fa-plus fa-sm"></i> Tambah Pegawai </button>') ?>
...
<table id="dataTable" class="table table-striped table-bordered nowrap" style="width:100%">
		...
		<tr>
          ...
          <td><?php echo $pgw->level ?></td>
			<td width="20px">
            <abbr title="edit" ><?php echo anchor('administrator/pegawai/edit/'.$pgw->id,'<div class="btn btn-sm btn-warning" ><i class="fa fa-edit" ></i></div>') ?></abbr>
