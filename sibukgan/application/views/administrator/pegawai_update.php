...
<div class="card-header">
		<a href="<?php echo site_url('administrator/pegawai/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
</div>
...
<div class="card-body">
	<form action="" method="post" class="row g-3">
		...
		<div class="col-md-6">
			...
			<input name="nama" class="form-control <?php echo form_error('nama') ? 'is-invalid':'' ?> mb-3" value="<?php echo $pegawai->nama ?>" ></input>
		...
		<div class="col-md-6">
			...
			type="text" name="nip" value="<?php echo $pegawai->nip ?>" maxlength="18"/>
			<div class="invalid-feedback">
		...
		<div class="col-md-6">
			...
			type="text" id="golongan" name="golongan" >
   			<option><?php echo $pegawai->golongan ?></option>
			<option>I/a</option>
			<option>I/b</option>
			<option>I/c</option>
			<option>I/d</option>
		...
		<div class="col-md-6">
			...
			<input class="form-control <?php echo form_error('jabatan') ? 'is-invalid':'' ?> mb-3"
			 name="jabatan" value="<?php echo $pegawai->jabatan ?>"/>
			<div class="invalid-feedback">
		...
		<div class="col-md-6">
			...
			type="text" id="pangkat" name="pangkat" >
   			<option><?php echo $pegawai->pangkat ?></option>
   			<option>-</option>
