...
foreach ($spt as $st) :
      ...
      ?>
		 	...
		 	<td width="20px"><abbr title="buat rincian" ><?php echo anchor('administrator/biaya/edit/'.$st->id_spt,'<div class="btn btn-sm btn-warning" ><i class="fa fa-edit" ></i></div>') ?></abbr>
		 	<a href="<?php echo base_url('administrator/biaya/cetak_biaya/'.$st->id_spt) ?>" target="_blank"><abbr title="cetak rincian"><div class="btn btn-sm btn-primary"><i class="fas fa-print"></i></div></abbr></a>
