...
<?php echo anchor('administrator/spt/add','<button class="btn btn-sm btn-primary mb-3"><i class="fas fa-plus fa-sm"></i> Buat ST</button>') ?>
...
foreach ($spt as $st) :
      ...
      ?>
		 	...
		 	<td><?php echo $st->pegawai ?></td>
		 	 <td width="20px"><abbr title="edit" ><?php echo anchor('administrator/spt/edit/'.$st->id_spt,'<div class="btn btn-sm btn-warning" ><i class="fa fa-edit" ></i></div>') ?></abbr>
		 	<a href="<?php echo base_url('administrator/spt/cetak_spt/'.$st->id_spt) ?>" target="_blank"><abbr title="cetak spt"><div class="btn btn-sm btn-primary"><i class="fas fa-print"></i></div></abbr></a>
