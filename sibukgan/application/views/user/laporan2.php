...
foreach ($laporan as $st) :
      ...
      ?>
		 	...
		 	<td width="20px"><abbr title="buat"><?php echo anchor('user/laporan2/edit/'.$st->id_spt,'<div class="btn btn-sm btn-primary"><i class="fas fa-file-invoice"></i></div>') ?></abbr></td>
		 	<td width="20px"><abbr title="edit"><?php echo anchor('user/laporan2/edit2/'.$st->id_spt,'<div class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></div>') ?></abbr></td>
		<td width="20px"><?php
