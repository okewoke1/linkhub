...
<table style="width:780px">
  ...
  <tr>
    ...
    <td width=320px valign="top">Sekadau,
  ...
  <tr>
    <td width=500px valign="top"></td>
    <td width=380px valign="top">Plh. Kepala Badan Pusat Statistik</td>
  </tr>
  </table>
  ...
  <tr>
    ...
    <td width=350px valign="top">Kabupaten Sekadau</td>
  </tr>
  </table>
  <br><br><br><br>

    <?php foreach($detail as $ts): ?>
  <div class="absolute" align="center"> <?php echo $ts->status_plh ?></div>
    <?php endforeach ?>
...
<?php foreach($detail as $ts): ?>
    ...
    Nomor : B-<?php echo $ts->no ?>/6109<?php echo $ts->nomor ?>/<?php echo $ts->kode_huruf ?>/<?php echo ($bln1);?>/<?php echo ($thn1);?>
    </p>
    <?php endforeach ?>
<table style="width:780px" >
<?php foreach($detail as $ts): ?>
